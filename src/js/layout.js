  ...
  <nav class="bg-[#211102] py-1.5">
    <div class="container md:px-20 flex flex-wrap items-center justify-between mx-auto py-2">
      ...
      >
        ...
        >
          <li><a href="#main-section" class="block py-2 px-3 hover:text-[#c68e17] duration-300 transition-all text-white">الرئيسية</a></li>
          <li><a href="#about" class="block py-2 px-3 hover:text-[#c68e17] duration-300 transition-all text-white">من نحن</a></li>
          <li><a href="menu.html" class="block py-2 px-3 hover:text-[#c68e17] duration-300 transition-all text-white">القائمة</a></li>
          <li><a href="#offers" class="block py-2 px-3 hover:text-[#c68e17] duration-300 transition-all text-white">عروضنا الخاصة</a></li>
          <li><a href="#testmonial" class="block py-2 px-3 hover:text-[#c68e17] duration-300 transition-all text-white">آراء عملائنا</a></li>
          <li><a href="bookYourTable.html" class="block py-2 px-3 hover:text-[#c68e17] duration-300 transition-all text-white">احجز طاولتك</a></li>
          <li><a href="#contactUs" class="block py-2 px-3 hover:text-[#c68e17] duration-300 transition-all text-white">تواصل معنا</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="container mx-auto md:px-20 ">
    <div class="flex flex-wrap mb-10 justify-between">
      ...
      <div class="lg:w-[22%]  w-[47%]"> 
        <div class="text-logo text-white">
          <h2 class="text-xl mb-5 text-[#c68e17]">روابط سريعة</h2>
      ...
      <div class="lg:w-[22%]  w-[47%]"> 
        <div class="text-logo text-white">
          <h2 class="text-xl mb-5 text-[#c68e17]">ساعات العمل</h2>
          <p class="text-sm my-4">من 8 صباحا حتي 11 مساء</p>
          <p class="text-sm my-4">تفصل بزياراتنا واستمتع بتجربة لا تنسى</p>
        </div>
      </div>

      <div class="lg:w-[22%] w-full mt-7 lg:mt-0"> 
        <div class="text-logo text-white">
          <h2 class="text-xl mb-5 text-[#c68e17]">وسائل الدفع</h2>
          <p class="text-sm my-4">ندعم كافة وسائل الدفع: مدى، فيزا، ماستر كارد — عشان راحتكم أولويتنا</p>
          <img src="img/footer-payment.webp" alt="طرق الدفع">
        </div>
      </div>

    </div>
    <div class="copy">
      <p class="text-white text-sm text-center border-t border-gray-800 pt-7">
